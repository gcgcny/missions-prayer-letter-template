...
### Using config.json (Advanced)

The template includes a `config.json` file as a reference for storing configuration.

To use it dynamically, uncomment lines 33-43 in `script.js`:
...
Then implement the `applyConfig()` function to populate content from the JSON file.

### Customizing Bootstrap Components

All Bootstrap 5 components can be customized. See the [Bootstrap 5 documentation](https://getbootstrap.com/docs/5.3/) for:
- Button styles
- Card layouts
- Grid system
- Spacing utilities
...
- Test on mobile by accessing from your phone (use local IP address)
- Check all sections scroll correctly
- Test tooltips (hover over Bible verses)
- Test collapse (security warning button)
...
- Use `.jpg`, `.png`, or `.svg` extensions

### Colors Not Changing

- Make sure you're editing `style.scss` (not `style.css`)
...
- Check for syntax errors in HTML/SCSS
- Clear `dist/` folder and rebuild

## Need Help?

- Check the [README.md](README.md) for setup instructions
- Review [Bootstrap 5 docs](https://getbootstrap.com/docs/5.3/)
- Review [Font Awesome icons](https://fontawesome.com/icons)
